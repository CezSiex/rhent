...
def send_test(message): 
	bot.send_photo(message.chat.id,'https://github.com/CezSiex/rhent/tree/master/photo/photo.jpg')  # random.choice(os.listdir('https://github.com/CezSiex/rhent/tree/master/photo/hPhoto/photo_kerabot'))
