...
def send_test(message): 
	bot.send_photo(message.chat.id, random.choice('https://raw.githubusercontent.com/CezSiex/rhent/master/photo/')))     # random.choice(os.listdir('https://github.com/CezSiex/rhent/tree/master/photo/hPhoto/photo_kerabot'))
